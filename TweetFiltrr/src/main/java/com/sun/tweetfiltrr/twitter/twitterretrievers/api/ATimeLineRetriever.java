...
public abstract class ATimeLineRetriever<T> implements ITwitterAPICall<Collection<ParcelableUser>> {
    ...
    public Collection<ParcelableUser> retrieveTwitterData(ICachedUser user_, ITwitterAPICallStatus failLis_) {
        return getUpdatedUserWithTimeline(user_, failLis_);
    }
     ...
     * @return
     */
    private Collection<ParcelableUser> getUpdatedUserWithTimeline(ICachedUser user_, ITwitterAPICallStatus failLis_){
        ...
        do {
            try {
                ...
                failLis_.onTwitterApiCallFail(currentUser, e, this);
