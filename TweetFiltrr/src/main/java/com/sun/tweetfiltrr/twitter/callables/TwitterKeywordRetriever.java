...
import com.sun.tweetfiltrr.parcelable.CachedKeywordFriendDetails;
...
public class TwitterKeywordRetriever implements Callable<Collection<ParcelableUser>> {

    private static final String TAG = TwitterKeywordRetriever.class.getName();
     ...
     * @param currentUser_
     */
    public TwitterKeywordRetriever(ParcelableUser currentUser_,
    ...
    public Collection<ParcelableUser> call() throws Exception {
        ICachedUser cachedDataUser = new CachedKeywordFriendDetails(_currentUser);
