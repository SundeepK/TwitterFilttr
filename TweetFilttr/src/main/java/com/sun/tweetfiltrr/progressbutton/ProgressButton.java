package com.sun.tweetfiltrr.progressbutton;
...
public class ProgressButton extends ImageButton {
	...
	/**
	 * {@link com.sun.tweetfiltrr.progressbutton.ProgressButton} can be used to display a simple rotating {@link android.graphics.drawable.Drawable} to give the user
	 * the effect of a loading button. The {@link android.graphics.drawable.Drawable} will be displayed once the user clicks the button and will have to be
	 * manually dismissed using the {@link #stopLoadingAnimation()} method.
	 * 
	 * @param context_
	 * 			the current {@link android.content.Context}
	 * @param attrs_
	 * 			the {@link android.util.AttributeSet} to retrieve data from compiled xml files
	 * @param defStyle_
	...
	/**
	 * Start or stop the current {@link android.graphics.drawable.Animatable} instance
	 * 
	 * @param shouldShow_
	 * 			to indicate whether {@link android.graphics.drawable.Animatable#stop()} or 
	 * 			{@link android.graphics.drawable.Animatable#start()} should be invoked on the current {@link android.graphics.drawable.Animatable} instance
	 */
